...
/* Phase 2 status screen: channel (hopper), World Model current counts
 * (TTL-aged AP records, OBSERVED station addresses - randomized MACs
 * count separately, no physical-device claim - and valid relations),
 * RX and drop. */
